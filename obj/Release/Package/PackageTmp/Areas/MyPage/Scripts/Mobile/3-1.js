...
$(document).ready(function () {
    ...
    function getreport(monthDifference) {
        ...
        var yearmonth = mypageTopDate.getFullYear() + "-" + (mypageTopDate.getMonth() + 1);

        $("#mypage_selected_month").html(mypageTopDate.getFullYear() + '年' + (mypageTopDate.getMonth() + 1) + '月');
        $("#mypagetopreportmonth").html(mypageTopDate.getMonth() + 1);

        var url = '/mypage/ChangeYearMonth/' + yearmonth + '/';
    ...
    function DispGraph(container_l, container_r, report, num) {
        ...
        switch (num) {
            case 1:
                ...
                $("#total_correct_percentage_month").html(mypageTopDate.getMonth() + 1);
