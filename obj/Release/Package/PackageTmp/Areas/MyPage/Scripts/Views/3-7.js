$(document).ready(function () {
    ...
    function save_setting() {
        ...
        var gender = 0;
        var radiolist_gender = document.getElementsByName("性別");
        for (var i = 0; i < radiolist_gender.length; i++) {
            if (radiolist_gender[i].checked) {
                if (radiolist_gender[i].value == "男性") {
                    gender = 1;
                }
                else if (radiolist_gender[i].value == "女性") {
                    gender = 2;
                }
                break;
            }
