...
{
    public class MyPageTopViewModel
    {
        #region -- RightColumnView

      //  public MyPageRightColumnViewModel RightColumnViews { get; set; }
        ...
        public int MonthlyPoint;   // 月別合計
        public int MonthlyRank;   // 月別順位
        public int TotalRank;   // 総合ランキング
        ...
        public string MonnthlyPointStr
        {
            get
            {
                string result = MonthlyPoint.ToString("##,##0");
