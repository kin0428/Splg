...
namespace Splg.Areas.MyPage.Controllers
{
    public class MyPageFollowersController : Controller
    {
        ...
        // todo: interfaceへ変更
        private MyPageFollowersService workerService;

        private SystemDatetimeService systemDatetimeService;

        #endregion

        public MyPageFollowersController()
        {
            // todo インスタンス管理
            this.workerService = new MyPageFollowersService(this.com);
        ...
        public ActionResult GetMoreFollowers(int currentCount)
        {
            long memberId = this.GetLoginMemberId();

            var viewModel = this.workerService.GetViewModel(memberId,
                                                         currentCount,
                                                         MyPageFollowersViewModel.INITIAL_PAGE_SIZE,
                                                         this.systemDatetimeService.TargetYear,
                                                         this.systemDatetimeService.TargetMonth);
